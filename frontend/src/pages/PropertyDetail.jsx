  ...
  if (error || !currentProperty) {
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <Link to="/properties" className="mt-4 text-indigo-600 hover:text-indigo-800">
          ← Back to Properties
        </Link>
      </div>
    );
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded text-sm capitalize">
                    {property.status.replace('_', ' ')}
                  </span>
                  <span className="px-3 py-1 bg-indigo-100 text-indigo-700 rounded text-sm capitalize">
